        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">사용자 정보 조회</h1>
          	<form class="form-horizontal" role="form">
				...
				<% LprodVO lvo = (LprodVO)request.getAttribute("lvo"); %>
				
				<div class="form-group">
					<label for="userNm" class="col-sm-2 control-label">lprod_id</label>
					<div class="col-sm-10">
						<label class="control-label"><%= lvo.getLPROD_ID() %></label>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<label class="control-label"><%= lvo.getLPROD_GU() %></label>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<label class="control-label"><%= lvo.getLPROD_NM() %></label>
					</div>
				</div>
